...
WebUI.scrollToElement(findTestObject('FILE_DOWNLOAD_OR/150kb_file'), 10)
...
WebUI.scrollToElement(findTestObject('FILE_DOWNLOAD_OR/500kb_file'), 10)
...
WebUI.scrollToElement(findTestObject('FILE_DOWNLOAD_OR/1mb_file'), 10)
